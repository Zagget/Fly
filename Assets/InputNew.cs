...
//     version 1.14.2
//     from Assets/InputNew.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/InputNew.inputactions".
/// </summary>
/// <remarks>
...
public partial class @InputNew: IInputActionCollection2, IDisposable
{
    ...
    ~@InputNew()
    {
        UnityEngine.Debug.Assert(!m_ActionMap.enabled, "This will cause a leak and performance issues, InputNew.ActionMap.Disable() has not been called.");
    }
    ...
    public struct ActionMapActions
    {
        ...
        /// </summary>
        public ActionMapActions(@InputNew wrapper) { m_Wrapper = wrapper; }
        /// <summary>
